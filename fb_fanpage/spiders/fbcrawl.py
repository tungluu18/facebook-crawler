...
from fb_fanpage.items import FbcrawlItem, parse_date, parse_date2
...
class FacebookSpider(scrapy.Spider):
    ...
    def parse_home(self, response):
        ...
        if response.xpath("//div/a[contains(@href,'save-device')]"):
            ...
            href = '/login/save-device/cancel/?flow=interstitial_nux&nux_source=regular_login'
            return response.follow(href, callback=self.parse_home)
            # return FormRequest.from_response(
            #     response,
